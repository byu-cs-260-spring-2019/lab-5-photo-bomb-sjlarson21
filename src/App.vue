<template>
  <div id="app">
    <div class="pure-menu">
      <span class="pure-menu-heading">Lab 5</span>
      <ul class="pure-menu-list">
        ...
        <li class="pure-menu-item">
          <router-link to="/photo" class="pure-menu-link">PHOTOS</router-link>
        </li>
        <li class="pure-menu-item">
          <a class="pure-menu-link" href="https://github.com/byu-cs-260-spring-2019/lab-5-photo-bomb-sjlarson21">GITHUB</a>
        </li>
      </ul>
    </div>
    <div class="content">
